...
if __name__ == "__main__":
    ...
    # task container
    t1 = threading.Thread(target=scrap_both_belong, args=(money_control, money_news, money_indi_2, money_indi_1, money_title, money_img, crypto_articles))
    t2 = threading.Thread(target=scrap_both_belong, args=(market_watch, market_news, market_indi_2, market_indi_1, market_title, market_img, crypto_articles))
    t3 = threading.Thread(target=scrap_both_belong, args=(investopedia, investopedia_news, investopedia_indi_2, investopedia_indi_1, investopedia_title, investopedia_img, crypto_articles))
